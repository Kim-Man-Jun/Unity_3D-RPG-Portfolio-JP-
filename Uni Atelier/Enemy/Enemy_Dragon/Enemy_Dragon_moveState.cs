...
public class Enemy_Dragon_moveState : EnemyState
{
    protected Enemy_Dragon enemy;
    private float RandomX;
    private float RandomZ;

    public Enemy_Dragon_moveState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Dragon enemy)
