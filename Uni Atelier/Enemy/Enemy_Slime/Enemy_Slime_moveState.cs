...
public class Enemy_Slime_moveState : EnemyState
{
    protected Enemy_Slime enemy;
    private float RandomX;
    private float RandomZ;

    public Enemy_Slime_moveState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Slime enemy)
